...
function writePassword() {
  // validPrompts variable stores the value of the optionPrompt decisions 
  ...
  // This if statements makes sure the user made decisions and returns true to run the rest of the code 
  if (choicesMade) {

  // Creates password variable that stores the return value of generatePassword function
...
// Declares generatePassword function and runs code to generate a new password 
function generatePassword(){
  // creates a variable with an empty string to store the value of the newly created password
  var password = "";
  // This for loop iterates the length of the password the user inputed until its no longer less than passwordLength
  for(var i = 0; i < passwordLength; i++) {
    // creates a variable to store the random index generated by the math.random(math.fooor) method 
